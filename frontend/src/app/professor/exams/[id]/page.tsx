...
export default function EditExamPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const [antiCheat, setAntiCheat] = useState({ fullscreen: true, tab_switch: true, copy_paste: true })
        ...
        try {
            ...
            if (localDraft) {
                try {
                    ...
                    setQuestions(parsed.questions || examData.questions || [])
                    ...
                    if (parsed.antiCheat) setAntiCheat(parsed.antiCheat)
                    else if (examData.anti_cheat_config) setAntiCheat(examData.anti_cheat_config)
            ...
            if (examData.anti_cheat_config) setAntiCheat(examData.anti_cheat_config)
    ...
    }, [title, selectedSubject, selectedClasses, duration, questions, startTime, accessEndTime, antiCheat, examId, loading])
    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto pb-12">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-2">
                        <div className="flex items-center space-x-2">
                            <input
                                type="checkbox"
                                checked={!!antiCheat.fullscreen}
                                onChange={e => setAntiCheat({ ...antiCheat, fullscreen: e.target.checked })}
                                className="h-4 w-4"
                            />
                        ...
                        <div className="flex items-center space-x-2">
                            <input
                                type="checkbox"
                                checked={!!antiCheat.tab_switch}
                                onChange={e => setAntiCheat({ ...antiCheat, tab_switch: e.target.checked })}
                                className="h-4 w-4"
                            />
                        ...
                        <div className="flex items-center space-x-2">
                            <input
                                type="checkbox"
                                checked={!!antiCheat.copy_paste}
                                onChange={e => setAntiCheat({ ...antiCheat, copy_paste: e.target.checked })}
                                className="h-4 w-4"
                            />
            ...
            <div className="flex justify-end pt-8 gap-4">
                ...
                <Button size="lg" className="bg-slate-900 text-white w-48" onClick={handleSubmit}>
                    Save Changes
                </Button>
            </div>
        </div>
